                ...
                <ol className="relative border-s border-teal keep-border">
                    <li className="mb-10 ms-4">
                        ...
                        <h4 className="text-lg text-sky">
                            Cambodia Academy of Digital Technology, Assignment
                            Project
                        </h4>
                        <ul className="mb-4 text-sm text-subtext0 font-normal list-disc ml-4">
                            <li>
                                ...
                                using a combination of different machine
                                learning models (
                            ...
                            <li>
                                ...
                                preprocessing pipeline, creating, and training
                                the deep learning model.
                            </li>
                            <li>
                                Learned how to create a basic NLP model for
                                sentimental analysis, and how to use machine
                                learning models effectively with text inputs.
                            </li>
                        </ul>
                    </li>
                    <li className="mb-10 ms-4">
                        ...
                        <ul className="mb-4 text-sm text-subtext0 font-normal list-disc ml-4">
                            ...
                            <li>
                                Responsible for the development of the
                                preprocessing pipeline and training the deep
                                learning model, as well as the transfer learning
                                cycle.
                            </li>
                            <li>
                                Learned the ins and outs of data engineering for
                    ...
                    <li className="mb-10 ms-4">
                        ...
                        <ul className="mb-4 text-sm text-subtext0 font-normal list-disc ml-4">
                            <li>
                                ...
                                for giving information about Cambodia Academy of
                                Digital Technology using simple machine learning
                                techniques.
                            </li>
                            <li>
                                Learned the basic of creating system and basic
                                machine learning algorithms.
                            </li>
                            <li>
                                The system is able to interact with 2 different
                                interfaces
                            </li>
                            <li>
                                Trusted to be a competent machine learning
                                engineer.
                            </li>
                        </ul>
                    </li>
